var url ="http://localhost/medicos/" ;
 	...
 	$(document).on("click","#enviarObservacao", function(event) { 
         ...
         avo =pai.parent(); 
 		avo.css('height','200'); 
 		$(this).after("<div class='comentarioMedico'><br/><textarea id='obs' rows='5' style=width:100%;></textarea><br/><button id='enviarObs' value="+id+"> Enviar </button> <button id='cancelar' value="+id+"> Cancelar </button> </div>"); 7 
